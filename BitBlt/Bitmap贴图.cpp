...
void drawBmp(HDC hdc)
{
	...
	//透明贴图
	BitBlt(hdc, 100, 100, 320, 579, hmemdc, 320, 0, SRCAND);//按位与
	BitBlt(hdc, 100, 100, 320, 579, hmemdc, 0, 0, SRCPAINT);//按位或


	//设置字体
	HFONT hfont = CreateFont(20, 0, 0, 0, 0, true, true, false, DEFAULT_CHARSET, 0, 0, 0, 0, L"黑体");
	SelectObject(hdc, hfont);
	//显示文字
	SetBkMode(hdc, TRANSPARENT);
	SetTextColor(hdc, RGB(0, 255, 0));
	TextOut(hdc, 300, 30, L"帅哥！", _tcslen(L"帅哥！"));

	

	RECT rc = { 500, 300, 600, 400 };
	//Rectangle(hdc, rc.left, rc.top, rc.right, rc.bottom);
	DrawText(hdc, L"大帅哥！", _tcslen(L"大帅哥！"), &rc ,DT_VCENTER);
	//5.资源释放
